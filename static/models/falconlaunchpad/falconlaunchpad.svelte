...
<script>
  ...
  const gltf = useGltf('/falconlaunchpad.gltf')
</script>
  ...
  {:then gltf}
    <T.Group rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <T.Mesh
        ...
        material={gltf.materials['BU.W']}
      />
      <T.Mesh
        geometry={gltf.nodes.Object_7.geometry}
        material={gltf.materials.Black_Pillars}
      />
      <T.Mesh
      ...
      <T.Mesh
        ...
        material={gltf.materials.Building_Blue}
      />
      <T.Mesh
        geometry={gltf.nodes.Object_27.geometry}
        material={gltf.materials.Grey_Mid_Floor}
      />
      <T.Mesh
      ...
      <T.Mesh
        ...
        material={gltf.materials.Main_Body}
      />
      <T.Mesh
      ...
      <T.Mesh
        ...
        material={gltf.materials.Silver_PARTS}
      />
      <T.Mesh
      ...
      <T.Mesh
        ...
        material={gltf.materials.White_Tanks}
      />
      <T.Mesh
        geometry={gltf.nodes.Object_45.geometry}
        material={gltf.materials.Yellow_Railings}
      />
      <T.Mesh
